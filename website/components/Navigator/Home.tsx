    ...
    return (
        <div className="group float-settings">
            <div className="w-10 flex flex-col items-center justify-center h-full p-2 group-hover:-translate-x-[20px] transition-all duration-300">
                ...
                <button id="back-history" type="button" className="py-1 px-3 mb-2 rounded" onClick={() => router.push("/")}>
                ...
                <button id="back-history" type="button" className="py-1 px-3 mb-2 rounded" onClick={() => router.back()}>
                ...
                <button id="back-history" type="button" className="py-1 px-3 mb-2 rounded" onClick={() => router.forward()}>
